  ...
  return (
    <div className="w-full h-full grid grid-cols-2 grid-rows-4 gap-2">
      <div className="row-span-3 flex flex-col gap-2 justify-center items-center col-span-2">
        <p className="font-bold text-2xl">Unlock Your Potential with this Platform</p>
        <p className="w-[90%] text-center text-neutral-500 font-semibold mt-5 leading-7 tracking-wide">Welcome to CMS, your gateway to boundless learning opportunities.
          ...
          and we are committed to providing <br /> you with the tools, resources, and support you need to excel.
          Whether you are seeking <br /> to enhance your skills, explore new fields, or push the limits of your knowledge,
        ...
        <div className="w-full flex gap-3 justify-center mt-5">
          <Link to='/instructor/courses'><Button>Explore Courses</Button></Link>
          <Link to="/instructor/earnings"><Button variant="outline">Your Earnings</Button></Link>
        </div>
      </div>
