...
export const StudentProfileInfo = createAsyncThunk(
    "/student/profile",
    async () => {
        const response = await fetch("https://course-management-system-il4f.onrender.com/student/profile/info" , {
            credentials : "include"
        })
...
export const StudentUpdateProfileInfo = createAsyncThunk(
    ...
    async (formData : IUpdateProfileData) => {
        const response = await fetch("https://course-management-system-il4f.onrender.com/student/profile/update", {
            credentials: "include",
            method: "PUT",
            headers: {
