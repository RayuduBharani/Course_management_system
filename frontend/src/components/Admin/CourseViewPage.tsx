...
export default function AdminCourseDetailesView() {
    ...
    const FetchCourseInfo = async () => {
        const response = await fetch(`https://course-management-system-il4f.onrender.com/courses/get/${id}`)
    ...
    const handleDelete = async (id: string) => {
        const response = await fetch(`https://course-management-system-il4f.onrender.com/admin/course/delete/${id}`, {
            method: "PUT"
        })
        const data = await response.json();
        if (data.success) {
