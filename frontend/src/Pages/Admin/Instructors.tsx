...
export default function AdminInstructors() {
    ...
    return (
        <div className="w-full h-full ">
            ...
            <div className="w-full h-[97%] pb-10 overflow-hidden overflow-y-scroll grid grid-cols-5 gap-5 ">
                {
                    data.map((d: any, index) => {
                        return (
                            <div key={index} className="border-2 h-fit rounded-lg p-3 flex flex-col items-center gap-3">
                                ...
                                }} className="w-full ">View Profile</Button>
                            </div>
                        )
                    })
                }
