...
export const FetchProfileInfo = createAsyncThunk(
    "instructor/profile",
    async () => {
        const response = await fetch("https://course-management-system-il4f.onrender.com/instructor/profile/view", {
            method: "GET",
            credentials: "include"
        })
...
export const UpdateInstructorProfileInfo = createAsyncThunk(
    ...
    async (formData : FORMDATA) => {
        const response = await fetch("https://course-management-system-il4f.onrender.com/instructor/profile/update", {
            method: "PUT",
            credentials: "include",
            headers : {
