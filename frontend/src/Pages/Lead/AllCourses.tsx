...
export default function LeadAllcourses() {
  ...
  const stats = useMemo(() => {
    ...
    const avgRating = 4.8; // This would ideally be calculated from actual ratings
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <Card className="overflow-hidden border-0 bg-primary text-primary-foreground">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-primary-foreground/80">
                Find the best courses for your team's growth
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Discover {courses.length}+ courses to empower your team</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filteredCourses.filter(course => course.instructor).map((course) => (
              ...
              <Card className="group cursor-pointer border-0 bg-card hover:bg-muted transition-colors duration-200">
                ...
                <CardContent className="p-4 space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    by {course.instructor?.name || 'Instructor unavailable'}
                  </p>
